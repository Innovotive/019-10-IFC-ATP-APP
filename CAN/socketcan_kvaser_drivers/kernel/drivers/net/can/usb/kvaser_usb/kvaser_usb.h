...
/* Device capabilities */
#define KVASER_USB_CAP_BERR_CAP			BIT(0)
#define KVASER_USB_CAP_EXT_CAP			BIT(1)
#define KVASER_USB_HYDRA_CAP_EXT_CMD		BIT(2)
#define KVASER_USB_CAP_STATIC_LISTEN_MODE	BIT(3)

#define KVASER_USB_SW_VERSION_MAJOR_MASK GENMASK(31, 24)
#define KVASER_USB_SW_VERSION_MINOR_MASK GENMASK(23, 16)
#define KVASER_USB_SW_VERSION_REVISION_MASK GENMASK(15, 0)
 ...
 * @dev_set_led:		turn on or off device LED
 *
