...
WAIT = 5             # seconds
POWER_TOL = 0.40     # ±20% tolerance for power validation

# KEEP EXACTLY AS USER WANTS — DO NOT MODIFY
GATE7_POINTS = [
    {"pdo_index": 4, "voltage_mv": 20000, "current_ma": 2990, "power_w": 60},  # 20V 2.99A
    {"pdo_index": 3, "voltage_mv": 15000, "current_ma": 3000, "power_w": 45},  # 15V 3A
    {"pdo_index": 2, "voltage_mv": 12000, "current_ma": 3000, "power_w": 36},  # 12V 3A
    {"pdo_index": 1, "voltage_mv": 9000,  "current_ma": 3000, "power_w": 27},  # 9V 3A
    {"pdo_index": 0, "voltage_mv": 5000,  "current_ma": 3000, "power_w": 15},  # 5V 3A
]
...
# =========================================================
# GATE 7 — FULL POWER NEGOTIATION TEST
# =========================================================
def run_gate7(pm):
    print("\n=======================================")
...
__all__ = ["run_gate7", "run_gate8_ocp"]
